...
///////////////////// VARIABLES ////////////////////
lv_anim_t * elementBlink_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * elementBlink_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_playback_delay(&PropertyAnimation_0, 600);
...
void ui_destroy(void)
{
    ...
    ui_aiTextScreen_screen_destroy();
}
